...
?>
<li><a href="{{{ URL::to('/market/') }}}/{{$btc_market->id}}" id="volume-{{$btc_market->id}}" title="Vol: {{sprintf('%.8f',$total_btc)}} BTC" alt="Vol: {{sprintf('%.8f',$total_btc)}} BTC"><span class="name">{{$btc_market->type}}</span>
...
<li class="title"><span class="name">COIN</span><span class="price">PRICE</span><span class="change">CHANGE</span></li>
	...
	?>
	<li><a href="{{{ URL::to('/market/') }}}/{{$ltc_market->id}}" id="volume-{{$ltc_market->id}}" title="Vol: {{sprintf('%.8f',$total_ltc)}} LTC" alt="Vol: {{sprintf('%.8f',$total_ltc)}} LTC"><span class="name">{{$ltc_market->type}}</span>
